...
public class StartCompetition
{
  ...
  private static final Logger logger = LoggerFactory
          .getLogger(StartCompetition.class);
  ...
  public String
    startCompetition (@ModelAttribute("hiddenData") HiddenData hiddenData,
    ...
    if ("start".equals(start)) {
      ...
      if (competitionControlService != null && competitionSetupService != null) {
        ...
        competitionControlService
                .setAuthorizedBrokerList(new ArrayList<String>());
...
//      logger.info("The spot market price = "
//                  + distributionUtilityService.getSpotPrice());
//    }
    else {
