      ...
      <table style="width: 100%">
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: experimentInstance, field: 'series', 'errors')}">
            <g:select optionKey="id" from="${edu.kit.iism.experimentcenter.Series.list()}" value="${experimentInstance?.series?.id}" name="series.id" noSelection="${['':'Select One...']}"></g:select>
          </td>
        </tr>
        ...
        <tr class="prop">
          <td colspan="2" valign="top" class="value ${hasErrors(bean: experimentInstance, field: 'description', 'errors')}">
